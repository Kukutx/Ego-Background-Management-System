...
func ItemHandler() {
	...
	commons.Router.HandleFunc("/item/update", updateController)                  //商品修改
}
// updateController 商品修改
...
// showItemDescCatController 显示修改页面信息
